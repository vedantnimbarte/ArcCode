...
//! learned about the user or project. Backed by [`arccode_learn::MemoryStore`].

use std::sync::{Arc, Mutex};

use crate::{Tool, ToolCtx};
use arccode_core::{ToolOutcome, ToolSpec};
use arccode_learn::hooks::LearnSignals;
use arccode_learn::memory::{MemoryDraft, MemoryScope, MemoryStore, MemoryType};
